...
<head>
    ...
    function drawRegionsMap() {
        var data = google.visualization.arrayToDataTable([
            ['Country', 'Buy'],
            <?php 
                $query = "SELECT DISTINCT Country FROM ordersinfo ";
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/Shop/index.php" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <?php 
                                    ...
                                    $nr_orders=mysqli_num_rows($result);
                                    ?>
                                <div class="info-box-content">
                                    <span class="info-box-text">Sales</span>
                                    <span class="info-box-number"><?php echo $nr_orders; ?></span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    $nr_members=mysqli_num_rows($result);
                                    ?>
                                    <span class="info-box-text">Members</span>
                                    <span class="info-box-number"><?php echo $nr_members; ?></span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
