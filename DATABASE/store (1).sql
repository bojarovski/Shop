...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2022 at 11:16 PM
...
(18, 58, 'mario_bojarovski', '2022-01-24', 6, 'To Be Shipped'),
(19, 58, 'mario_bojarovski', '2022-01-24', 6, 'To Be Shipped'),
(20, 58, 'mario_bojarovski', '2022-01-24', 4, 'To Be Shipped'),
(21, 60, 'admin', '2022-01-24', 4, 'Done'),
(22, 60, 'admin', '2022-01-24', 3, 'Done'),
(23, 60, 'admin', '2022-01-24', 1, 'Done');
...
(1, 'admin', 'mmmmmm', 'fcvctghvyu       ', 'Albania', 'Neue Amberger Straße', '44', 'Grafenwöhr', 2147483647, 92655, 'admin@admin.com');
...
(59, 0, 'mario_bojarovski', 'mmmmmm', 'fcvctghvyu', 'Belgium', 'Neue Amberger Straße', '46', 'Grafenwöhr', 2147483647, 92655, 'mario.bojarovski', 'sadsad', 756),
(60, 1, 'admin', 'mmmmmm', 'fcvctghvyu        ', 'Albania', 'Neue Amberger Straße', '44', 'Grafenwöhr', 2147483647, 92655, 'admin@admin.com', 'asdsadasdsadsadsa', 538);
...
(2, 'mario_bojarovski', 'aeb34368c5d53aee32431b5386f71c56', 'mariobojarovski1407@gmail.com', '2022-01-24');
...
--
ALTER TABLE `finalorder`
  MODIFY `finalOrderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `orders`
  MODIFY `orderId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;

--
-- AUTO_INCREMENT for table `ordersinfo`
--
ALTER TABLE `ordersinfo`
  MODIFY `ordersinfoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
